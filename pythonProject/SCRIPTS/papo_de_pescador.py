...
if (peso > 50):
    exc = peso - 50
    multa = exc * 4
    print('VALOR INFORMADO {}KG\nMAXIMO [50]KG\nDIFERENCA [{}]KG\n'.format(peso, exc))
    print(
        'O VALOR INFORMADO DE [{}]KG ULTRAPASSOU VALOR MAXIMO DE [50 KG]\nSERA COBRADO MULTA COM VALOR DE [{}]'.format(
            peso, multa))

elif (peso <= 50):
    print('NAO HA NECESSIDADE DE PAGAR MULTA :)')
